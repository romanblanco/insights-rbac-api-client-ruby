...
module RBACApiClient
  class Access
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RBACApiClient::Access`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] resource_definitions Value to be assigned
    def resource_definitions=(resource_definitions)
      if resource_definitions.nil?
        fail ArgumentError, 'resource_definitions cannot be nil'
      end
